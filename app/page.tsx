          ...
          <div className="flex flex-col md:flex-row items-center gap-8 md:gap-16 w-full">
            ...
            >
              ...
              >
                ...
                <Link href="mailto:ans7@example.com">
                  <Button variant="ghost" size="icon">
    ...
    <div className="grid md:grid-cols-2 gap-12 items-center">
      <div>
        ...
        <div className="mb-4 p-4 bg-card rounded-lg">
          ...
          <p className="text-sm">
            Artificial Intelligence | Cloud Innovation | Web3 & Blockchain | Stock Market Trends | 
        ...
        <div className="p-4 bg-card rounded-lg">
          ...
          <p className="text-sm">
            Book Lover 📖 | Photography Aficionado 📸 | Fitness Enthusiast 🏋️‍♂️ | 
            Space Explorer 🌌 | Crypto Researcher ₿
          </p>
        </div>
      ...
      <section id="skills" className="py-20">
        <div className="container">
          <h2 className="text-3xl font-bold mb-12 text-center"><MagneticButton className="text-3xl font-bold px-8 py-6">About Me</MagneticButton></h2>
...
<section id="certifications" className="py-20 bg-muted/50">
  <div className="container">
    <h2 className="text-3xl font-bold mb-12 text-center"><MagneticButton className="text-3xl font-bold px-8 py-6">Certifications</MagneticButton></h2>
    <div className="grid md:grid-cols-2 gap-8">
      ...
      {/* For certificates you don't have links for yet */}
      <Card>
        <CardContent className="p-6">
      ...
      <section id="projects" className="py-20">
        <div className="container">
          <h2 className="text-3xl font-bold mb-12 text-center"><MagneticButton className="text-3xl font-bold px-8 py-6">Featured Projects</MagneticButton></h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <ProjectCard
              ...
              imageUrl="/credit_card.png?height=200&width=400"
              demoUrl="#"
            ...
            <ProjectCard
              ...
              imageUrl="/resume.png?height=200&width=400"
              demoUrl="#"
            ...
            <ProjectCard
              ...
              imageUrl="/placement.png?height=200&width=400"
              demoUrl="#"
            ...
            <ProjectCard
              ...
              imageUrl="/scrapping.png?height=200&width=400"
              demoUrl="#"
            ...
            <ProjectCard
              ...
              imageUrl="/sign.png?height=200&width=400"
            />
            ...
            <ProjectCard
              ...
              tags={["C++", "Aurdino"]}
              imageUrl="/bin.png?height=200&width=400"
              demoUrl="#"
