...
const projectImages = {
  ...
  sign: '/sign.png',
  bin: '/bin.png',
  emojilang: '/emojilang.png',
  meetmind: '/meetmind.png',
  securepay: '/securepay.png',
   recipe: '/recipe.png',
  vaultify: '/vaultify.png', // Added this for Vaultify project
};
            ...
            <Card className="bg-card/50">
              <CardContent className="p-6">
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <SkillBadge name="Data Base Management System" />
                  <SkillBadge name="Object Oriented Programming" />
      ...
      <section id="certifications" className="py-20 bg-muted/50">
        <div className="container px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card>
              <CardContent className="p-6">
                <h3 className="text-xl font-semibold mb-2">Introduction to Generative AI</h3>
                <p className="text-muted-foreground mb-4">Google Cloud Skills Boost</p>
                <p className="mb-4">Comprehensive understanding of generative AI fundamentals, applications, and implementation strategies.</p>
                <Button variant="link" asChild>
                  <Link href="https://www.cloudskillsboost.google/public_profiles/80441468-e2da-4b4f-add1-b789c6fcc18b/badges/6181696" target="_blank">
                    View Certificate
                  </Link>
                </Button>
              </CardContent>
            ...
            <Card>
              <CardContent className="p-6">
                <h3 className="text-xl font-semibold mb-2">Introduction to Large Language Models</h3>
                <p className="text-muted-foreground mb-4">Google Cloud Skills Boost</p>
                <p className="mb-4">Deep dive into LLM architecture, training methodologies, and practical applications in modern AI systems.</p>
                <Button variant="link" asChild>
                  <Link href="https://www.cloudskillsboost.google/public_profiles/80441468-e2da-4b4f-add1-b789c6fcc18b/badges/6181842" target="_blank">
                    View Certificate
                  </Link>
                </Button>
              </CardContent>
            ...
            <Card>
              <CardContent className="p-6">
                <h3 className="text-xl font-semibold mb-2">Getting Started with AI</h3>
                <p className="text-muted-foreground mb-4">IBM</p>
                <p className="mb-4">Foundational knowledge in artificial intelligence concepts, machine learning basics, and AI implementation strategies.</p>
                <Button variant="link" asChild>
                  <Link href="https://drive.google.com/file/d/1hYipPXFLjxsXtk_RnVGKkejgaNTHFK0b/view?usp=drive_link" target="_blank">
                    View Certificate
                  </Link>
                </Button>
              </CardContent>
            ...
            <Card>
              <CardContent className="p-6">
                <h3 className="text-xl font-semibold mb-2">Mastering Data Structures & Algorithms</h3>
                <p className="text-muted-foreground mb-4">Udemy | Abdul Bari</p>
                <p className="mb-4">Advanced training in algorithmic thinking, problem-solving techniques, and optimized coding practices.</p>
                <Button variant="link" asChild>
                  <Link href="https://drive.google.com/file/d/1MZUYrNw_QsxGeEYJ-uU37vQv_IjUZHAC/view?usp=drive_link" target="_blank">
                    View Certificate
                  </Link>
                </Button>
              </CardContent>
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground mb-4">NPTEL</p>
                <p className="mb-4">Comprehensive study of network theory, graph algorithms, and social media analytics.</p>
                <Button variant="link" asChild>
                  <Link href="https://drive.google.com/file/d/1Uo-KahiKsWJCdsHlq7232L1Teat0Jkjz/view?usp=drive_link" target="_blank">
                    View Certificate
                  </Link>
                </Button>
              </CardContent>
            ...
            <Card>
              <CardContent className="p-6">
                <h3 className="text-xl font-semibold mb-2">Blockchain and Its Applications</h3>
                <p className="text-muted-foreground mb-4">NPTEL</p>
                <p className="mb-4">In-depth exploration of blockchain technology, cryptocurrency, and decentralized application development.</p>
                <Button variant="link" asChild>
                  <Link href="https://drive.google.com/file/d/1doq7gGWharJ4zKIcjqtPI-48SZxas6Nc/view?usp=drive_link" target="_blank">
                    View Certificate
                  </Link>
                </Button>
              </CardContent>
          ...
          <div className="flex justify-center mt-12">
            <Button asChild className="text-lg px-8 py-4">
              <Link href="https://drive.google.com/drive/folders/1M4fW8KTO3pKQ1eZn_-CMrCr13eiQodZ0?usp=sharing" target="_blank">
        ...
        <div className="container px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <ProjectCard
              ...
              description="💳 Modern full-stack payment processing solution with enterprise-grade security and Apple-inspired design. Supports 7+ major card types with real-time detection and automatic formatting."
              tags={['React.js', 'Flask', 'Stripe API', 'TailwindCSS', 'Security']}
              imageUrl={projectImages.securepay}
              demoUrl="https://secure-pay-payment-gateway-frontend.vercel.app/"
              repoUrl="https://github.com/anshmittal2004/SecurePay-PaymentGateway"
            />
            <ProjectCard
              title="EmojiLang - Fun Emoji Programming"
              description="🎯 Revolutionary emoji-based programming language designed for kids! Features a complete online compiler that makes coding accessible and fun through visual emoji syntax, fostering early computational thinking skills."
              tags={['JavaScript', 'React.js', 'Node.js', 'Compiler Design', 'Education Tech']}
              imageUrl={projectImages.emojilang}
              demoUrl="https://emoji-lang-a-fun-emoji-based-langua.vercel.app/"
              repoUrl="https://github.com/anshmittal2004/EmojiLang-A-Fun-Emoji-Based-Language-Online-Compiler-for-Kids-"
            />
            <ProjectCard
              title="MeetMind - AI Meeting Summarizer"
              description="🤖 Comprehensive AI-driven meeting management solution that transforms raw transcripts into actionable business intelligence. Eliminates manual note-taking with smart summarization and insight distribution."
              tags={['Python', 'Flask', 'OpenAI API', 'NLP', 'React.js']}
              imageUrl={projectImages.meetmind}
              repoUrl="https://github.com/anshmittal2004/MeetMind-AI-Meeting-Notes-Summarizer"
            />
            <ProjectCard
              title="Vaultify-2025"
            ...
            />
            <ProjectCard
              title="Recipe Preparation Agent"
              description="🍳 Innovative AI-powered culinary assistant developed as part of IBM internship project. Built using IBM Watsonx AI Studio and Granite-3-3-8b-instruct model with Retrieval-Augmented Generation (RAG) for personalized cooking guidance."
              tags={['IBM Watsonx', 'Granite AI Model', 'RAG', 'Python', 'AI Assistant']}
              imageUrl={projectImages.recipe}
              repoUrl="https://github.com/anshmittal2004/Recipe-Preparation-Agent-AI-Powered-Culinary-Assistant"
            />
            <ProjectCard
            ...
            />
              <ProjectCard
              title="ISL Translation Solution[Prototype]"
